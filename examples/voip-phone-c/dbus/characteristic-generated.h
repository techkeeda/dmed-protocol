...
#ifndef __CHARACTERISTIC_GENERATED_H__
#define __CHARACTERISTIC_GENERATED_H__
...
struct _OrgBluezGattCharacteristic1Iface
{
  ...
  GVariant * (*get_value) (OrgBluezGattCharacteristic1 *object);
...
GVariant *org_bluez_gatt_characteristic1_get_value (OrgBluezGattCharacteristic1 *object);
GVariant *org_bluez_gatt_characteristic1_dup_value (OrgBluezGattCharacteristic1 *object);
void org_bluez_gatt_characteristic1_set_value (OrgBluezGattCharacteristic1 *object, GVariant *value);
...
#endif /* __CHARACTERISTIC_GENERATED_H__ */
